...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个北印大学生, Hi，我是一个程序员,Hi，我是一个干饭人,欢迎来到我的博客🎉',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.lin179.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客,林林', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '1791598990@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/linlin449', // 你的github个人主页 例如 https://github.com/tangly1024
